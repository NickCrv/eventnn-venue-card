#!/usr/bin/env python3
"""
Safe HTTP Server for EventNN Venue
Binds only to localhost to prevent network connectivity issues
"""
...
# Configuration
PORT = 8000
HOST = '127.0.0.1'  # Only bind to localhost, not all interfaces
...
def main():
    ...
    try:
        ...
        with socketserver.TCPServer((HOST, PORT), SafeHTTPRequestHandler) as httpd:
            print(f"🚀 Safe HTTP Server started")
